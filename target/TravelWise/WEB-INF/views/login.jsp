...
<%@ taglib uri="http://www.springframework.org/tags/form" prefix = "form" %>
    ...
    <body>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body register">
                                    ...
                                    <p><input type="text" name="username" required placeholder="Username" autocomplete="off" class="username form-control placeholder-no-fix">
                                        <h4><i style="color:green;" class="fa fa-check"></i><i style="color:red;" class="fa fa-times"></i></h4>
                                    </p>
        ...
        <script>
            $.backstretch(["resources/assets/img/login-backdrop.jpg", "resources/assets/img/login-background.jpg"], {
                fade: 750,
                duration: 4000
            });
        </script>
