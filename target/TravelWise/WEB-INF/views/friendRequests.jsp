                        ...
                        <div id="sidebar" class="nav-collapse ">
							...
							class="fa fa-child"></i> <span>Friends</span>
                                    ...
                                    <ul class="sub">
                                        ...
                                        <li class="active"><a href="friendRequests">Friend
									Requests</a></li>
                                            ...
                                            <div class="form-panel">
                                                <form:form method="POST" action="acceptRequest">
                                                    <a href="profile?personId=${person.getpId()}">
                                                        <h3>
                                                            <i class="fa fa-angle-right"></i> <img onerror="this.src='resources/assets/img/default.png';" src="${person.getProfilePicPath()}" width=150 height=150 class="img-circle" /> ${person.getFirstName()} ${person.getLastName()}
                                                    </a>
                                                ...
                                                <form:form method="POST" class="pull-right" action="unFriend">
                                                    <button type="submit" name="submitDecline" class="btn btn-danger btn-sm">Decline</button>
                                                    </h3>
                                                    <input type="hidden" name="personId" value="${person.getpId()}" />
                                                </form:form>
                                            </div>
