...
<script src="resources/assets/js/custom/photounlikes.js"></script>
<script src="resources/assets/js/custom/photolikes.js"></script>
<script src="resources/assets/js/custom/photocomments.js"></script>
			...
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<c:if test="${sessionScope.requestCount > 0}">
						<li class="sub-menu"><a href="javascript:;"> <i
								class="fa fa-child"></i> <span>Friends
									&nbsp;&nbsp;&nbsp;&nbsp; <span class="badge bg-theme"><c:out
											value="${sessionScope.requestCount}"></c:out></span>
							</span>
						</a>
					</c:if>
					<c:if test="${sessionScope.requestCount == 0}">
					...
					<ul class="sub">
						...
						<c:if test="${sessionScope.requestCount > 0}">
							<li><a href="friendRequests">Friend
									Requests&nbsp;&nbsp;&nbsp;&nbsp; <span class="badge bg-theme"><c:out
											value="${sessionScope.requestCount}"></c:out> </span>
							</a></li>
						</c:if>
						<c:if test="${sessionScope.requestCount == 0}">
							<li><a href="friendRequests">Friend Requests</span>
							</a></li>
						</c:if>
				...
				<div class="row">
					<div id="searchArea" class="col-lg-9">
						...
						<div class="row mt">
									...
									<div class="project">
										<div class="photo-wrapper">
											...
											<div class="registration">
												<c:if
													test="${sessionScope.user.getuId() == person.getpId()}">
													<span> <a data-toggle="modal"
														href="profile.html#imageUpload"> Change Profile
															Picture</a>
													</span>
												</c:if>
											</div>
							...
							<!-- col-lg-4 -->
							<div id="divSave" style="margin-top: 0px;"
								class="col-lg-7 form-panel">
								...
								<div class="col-lg-7 col-md-4 col-sm-4 col-xs-12 desc">
									...
									<c:if
										test="${checkIfNotFriend && sessionScope.user.getuId() != person.getpId()}">
							...
							<!-- col-lg-7-->
							<div id="divEdit" style="margin-top: 0px;"
								class="col-lg-7 form-panel">
								<form:form class="form-inline" method="POST"
									commandName="userAccount" action="editDetails">
									<button type="submit" class="pull-right submitLink" id="save">Save</button>
									<div class="col-lg-7 col-md-4 col-sm-4 col-xs-12 desc">
										<input type='hidden' name="pId" value="${person.getpId()}" />
										<p>
											<input type="text" required name="firstName"
												value="${person.getFirstName()}" placeholder="First Name"
												autocomplete="off" class="form-control placeholder-no-fix">
										<p>
											<input type="text" required name="lastName"
												value="${person.getLastName()}" placeholder="Last Name"
												autocomplete="off" class="form-control placeholder-no-fix">
										</p>
										<p>
										...
										<p>
											<input type="text" required id="email"
												onblur="validateEmail();" name="email"
												value="${person.getEmail()}" placeholder="Email"
												autocomplete="off" class="form-control placeholder-no-fix">
										</p>
										<p>
										...
										<p>
											<input type="text" name="dob" placeholder="Date of Birth"
												value="${person.getDobString()}" autocomplete="off"
												class="form-control placeholder-no-fix">
										</p>
										<c:if test="${person.getGender() == 'Male'}">
											<p>
												<input type="radio" checked="checked" name="gender"
													id="gender" value="Male" class="radio-inline"> Male</input>
										...
										<c:if test="${person.getGender() == 'Female'}">
											<p>
												<input type="radio" name="gender" id="gender" value="Male"
													...
													checked="checked" name="gender" id="gender" value="Female"
													class="radio-inline"> Female</input>
											</p>
										</c:if>
					...
					<div aria-hidden="true" aria-labelledby="ImageUpload" role="dialog"
						tabindex="-1" id="imageUpload" class="modal fade">
					...
					<div aria-hidden="true" aria-labelledby="myModalLabel"
						role="dialog" tabindex="-1" id="postModal" class="modal fade">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal"
					...
					<div aria-hidden="true" aria-labelledby="myModalLabel"
						role="dialog" tabindex="-1" id="photoModal" class="modal fade">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal"
								...
								<div class="modal-body">
									<form:form commandName="photo" method="post"
										enctype="multipart/form-data" action="photo/upload">
										<div class="form-group">
