...
<body>
	...
	<div id="login-page">
		<div class="container">
			...
			<div class="registration">
				Don't have an account yet?<br /> <span> <a
					data-toggle="modal" href="login.html#myAccountModal"> Create an
						Account</a>
		...
		<!-- Modal -->
		<form:form class="form-login" method="POST" action="register"
			commandname="userAccount">
			<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog"
				tabindex="-1" id="myAccountModal" class="modal fade">
						...
						<div class="modal-body register">
							...
							<p>
								<input type="text" name="username" required
									...
									class="username form-control placeholder-no-fix">
							<h4>
							...
							<p>
								<input id="repassword" type="password" required
									name="repassword" onkeyup="checkPassword(); return false;"
	...
	<script>
	$.backstretch([ "resources/assets/img/login-backdrop.jpg",
		"resources/assets/img/login-backdrop1.jpg",
		"resources/assets/img/login-background.jpg",
		"resources/assets/img/login-background2.jpg",
		"resources/assets/img/thai.jpg" ], {
	    fade : 750,
	    duration : 3000
	});
    </script>
