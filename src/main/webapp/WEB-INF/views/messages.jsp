      ...
      TOP BAR CONTENT & NOTIFICATIONS
       -->
                ...
                <header class="header black-bg">
                    ...
                    <!--logo start-->
                    <a href="/TravelWise/index" class="logo"><b>TW</b></a>
                    <!--logo end-->
                    <div class="nav notify-row" id="top_menu">
                        <!--  notification start -->
                        <ul class="nav top-menu">
                            <!-- settings start -->
                            <li class="dropdown"><a data-toggle="dropdown" class="notification dropdown-toggle" href="index.html#"> <i
                            ...
                            <li id="header_inbox_bar" class="dropdown"><a data-toggle="dropdown" class="messages dropdown-toggle" href="index.html#"> <i class="fa-white fa-envelope-o"></i> <span
                                    ...
                                    <c:forEach var="person" items="${sessionScope.messageList}">
                                        <li>
                                            <a href="getMessage?personId=${person.getpId()}">
                                                <div class="task-info">
                                                    <div class="desc">${person.getFirstName()} ${person.getLastName()}
                                                    </div>
                                                </div>
                                            </a>
                                        </li>
                    ...
                    <section class="wrapper">
                        ...
                        <div class="row">
                            <div id="searchArea" class="col-lg-9 main-chart">
                                ...
                                <h3>
                                    <img class="img-circle" onerror="this.src='resources/assets/img/default.png';" style="width: 30px; height: 30px;" src="${person.getProfilePicPath()}">${person.getFirstName()} ${person.getLastName()}
                                </h3>
                                    ...
                                    <c:forEach var="message" items="${messages}">
                                        <c:if test="${message.getFromUser().getpId() != sessionScope.user.getuId()}">
                                            <div class="message form-panel pull-left">
                                                <img onerror="this.src='resources/assets/img/default.png';" src="${message.getFromUser().getProfilePicPath()}" width=20px class="img-circle pull-left" />
                                                <h6>
                                        ...
                                        <c:if test="${message.getFromUser().getpId() == sessionScope.user.getuId()}">
                                            <div style="background-color: #68dff0;" class="message form-panel pull-right">
                                                <img onerror="this.src='resources/assets/img/default.png';" src="${message.getToUser().getProfilePicPath() }" width=20px class="img-circle pull-left" />
                                                <h6>
                                                    &nbsp; ${message.getFromUser().getFirstName()} ${message.getFromUser().getLastName()}
                                                    </a>
                                                </h6>
