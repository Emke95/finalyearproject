...
<c:url value="/makePublic?id=" var="publicUrl" />
					...
					<div id="searchArea" class="col-lg-9 main-chart">
						...
						<div class="row mtpost">
							<div class="form-panel">
								<h4>Post</h4>
								<form:form class="form-horizontal tasi-form" commandName="posts"
							...
							<div class="form-panel">
								...
								<form:form commandName="photo" method="post"
									...
									<div class="form-group">
										<input type="file" class="form-control loader" id="read"
											name="pic"/>
									</div>
							...
							<div class="row mtpost">
								<div class="form-panel">
									...
									<td class="text-center"><a
										href="${publicUrl}${photo.getPhotoId()}"
										class="btn btn-sm btn-primary">Make Public</a></td>
								</div>
								<!-- /col-lg-9 -->
							</div>
							<!-- /row -->
								...
								<div class="form-panel">
									<a href="profile?personId=${post.getPerson().getpId()}"> <img
										...
										<h4>&nbsp; ${post.getPerson().getFirstName()}
											${post.getPerson().getLastName()}</h4></a> <br />
									<p>
