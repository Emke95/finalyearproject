                ...
                <section id="container">
                    ...
                    <header class="header black-bg">
                        ...
                        <div class="nav notify-row" id="top_menu">
							...
							class="fa-white fa-th-list"></i> <span class="badge bg-theme">
                                        ...
                                        <c:forEach var="notification" items="${sessionScope.notificationList}">
                                            <li>
                                                <a href="post?postId=${notification.getPosts().getPostId()}">
                                                 ...
                                                 <a href="photo?photoId=${notification.getPhoto().getPhotoId()}">
                                                    <div class="task-info">
                                                        <div class="desc">${notification.getNotification()}</div>
                                                    </div>
                                                </a>
                                    ...
                                    <c:forEach var="photo" items="${photos}">
										...
										<h4>
											...
											<i class="fa fa-thumbs-down"></i> unlike
                                                ...
                                                <button type="submit" class="addPhotoComment btn btn-theme btn-xs">Comment</button>
                                            </div>
                                            <!-- /col-lg-9 -->
                                        </div>
                                        <!-- /row -->
